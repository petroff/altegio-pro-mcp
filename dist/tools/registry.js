...
const tools = [
    ...
    },
    {
        ...
        description: 'Create employee work schedule. AUTHENTICATION REQUIRED - administrative access to create staff working schedule. Defines when an employee is available to work (e.g., "Monday 9:00-18:00"). Use this to set up or modify work hours.',
        inputSchema: {
            type: 'object',
            properties: {
                company_id: { type: 'number', description: 'ID of the company' },
    ...
    },
    {
        ...
        description: 'Update employee work schedule. AUTHENTICATION REQUIRED - administrative access to modify staff working schedule. Updates existing work hours for a specific date.',
        inputSchema: {
            type: 'object',
            properties: {
                company_id: { type: 'number', description: 'ID of the company' },
    ...
    },
    {
        ...
        description: 'Delete employee work schedule for a specific date. AUTHENTICATION REQUIRED - administrative access to remove staff working schedule. Removes work hours for the specified date.',
        inputSchema: {
            type: 'object',
            properties: {
                company_id: { type: 'number', description: 'ID of the company' },
    ...
    {
        name: 'get_positions',
        description: 'Get list of positions in company. AUTHENTICATION REQUIRED. Returns all available positions that can be assigned to staff members.',
        inputSchema: {
            type: 'object',
            properties: {
    ...
    },
    {
        ...
        description: 'Create a new position. AUTHENTICATION REQUIRED. Positions are used to categorize staff roles (e.g., "Manager", "Stylist", "Receptionist").',
        inputSchema: {
            type: 'object',
            properties: {
                company_id: { type: 'number', description: 'Company ID' },
    ...
    },
    {
        ...
        description: 'Update existing position. AUTHENTICATION REQUIRED. Modify position title or external ID.',
        inputSchema: {
            type: 'object',
            properties: {
                company_id: { type: 'number', description: 'Company ID' },
    ...
    },
    {
        ...
        description: 'Delete position. AUTHENTICATION REQUIRED. Note: Cannot delete positions that are assigned to staff members.',
        inputSchema: {
            type: 'object',
            properties: {
                company_id: { type: 'number', description: 'Company ID' },
